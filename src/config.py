...
BURNING, FROZEN, QUICKEN = 10, 11, 12
ELEMENTS = (ANEMO, CRYO, DENDRO, ELECTRO, GEO, HYDRO, PYRO)
ELEMENT_NAMES = ('anemo', 'cryo', 'dendro', 'electro', 'geo', 'hydro', 'pyro')
ELEMENTS_NUM = len(ELEMENTS)
AURA_TAX = 0.8
AVAILABLE_GAUGES = (1, 1.5, 2, 4, 8)
# SRP = (QUICKEN, ELECTRO, PYRO, ANEMO, HYDRO, CRYO, FROZEN, DENDRO)
SRP = {
    # FIXME these things react with BURNING? FROZEN? QUICKEN? 7-8 elements each line
    PYRO: (ELECTRO, ANEMO, HYDRO, FROZEN, CRYO, QUICKEN, DENDRO),
    HYDRO: (BURNING, PYRO, ANEMO, CRYO, QUICKEN, DENDRO, ELECTRO),
    DENDRO: (QUICKEN, ELECTRO, BURNING, PYRO, HYDRO),
    ELECTRO: (QUICKEN, BURNING, PYRO, ANEMO, HYDRO, CRYO, FROZEN, DENDRO), # FIXME clearly notes that CRYO > FROZEN here
    CRYO: (ELECTRO, BURNING, PYRO, ANEMO, HYDRO),
    ANEMO: (ELECTRO, BURNING, PYRO, HYDRO, CRYO, FROZEN), # FIXME here too
    GEO: (ELECTRO, BURNING, PYRO, HYDRO, CRYO, FROZEN)
}
