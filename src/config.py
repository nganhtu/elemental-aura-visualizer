...
# SRP = (QUICKEN, ELECTRO, PYRO, ANEMO, HYDRO, CRYO, FREEZE, DENDRO)
SRP = {
    # FIXME these things react with BURNING? FREEZE? QUICKEN? 7-8 elements each line
    ...
    ELECTRO: (QUICKEN, PYRO, BURNING, ANEMO, HYDRO, CRYO, FREEZE, DENDRO), # FIXME clearly notes that CRYO > FREEZE here
    CRYO: (ELECTRO, PYRO, ANEMO, HYDRO),
    ANEMO: (ELECTRO, PYRO, BURNING, HYDRO, CRYO, FREEZE), # FIXME here too
    GEO: (ELECTRO, PYRO, BURNING, HYDRO, CRYO, FREEZE)
}
